...
public final class P70_CDNUploadWorkerStart implements Packet {
    ...
    public P70_CDNUploadWorkerStart(String user, String token, String filename, byte[] sha256, long totalLength, long totalPackets) {
        this.user = user;
        this.token = token;
    ...
    public P70_CDNUploadWorkerStart(ByteBuf buffer) {
